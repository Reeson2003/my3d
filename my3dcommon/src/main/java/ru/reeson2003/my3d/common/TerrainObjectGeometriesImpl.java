 ...
 */
public class TerrainObjectGeometriesImpl implements TerrainObjectGeometries {
    private static TerrainObjectGeometries instance;
    private static Map<Long, List<Geometry>> geometryHashMap;
    private static Exception exception;

    static {
        geometryHashMap = new HashMap<>();
        try {
            geometryHashMap = GeometryLoader.load();
            if (geometryHashMap == null)
                instance = null;
            else
                instance = new TerrainObjectGeometriesImpl();
        } catch (Exception e) {
            exception = e;
            instance = null;
        }
    ...
    private TerrainObjectGeometriesImpl() {
